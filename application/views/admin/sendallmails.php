				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-offset-2 col-md-8">
							<form role="form" class="form-horizontal" method="post" action="<?=base_url()?>admin/sendEmailallUsers">
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									    <input type="text" name="to" class="form-control" id="inputEmail3"  placeholder="Multiple Users" disabled>
									</div>
								</div>
								<div class="form-group">
