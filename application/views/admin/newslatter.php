			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?php echo $table_row_count = $this->db->count_all('questions'); ?></div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Email Details
						<div class="pull-right">
							<a href="<?=base_url()?>admin/sendallmails" class="btn btn-primary" role="button">Send email to all users</a>
						</div>
					</div>
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="sendemail" data-sortable="true">Send Email</th>
						    </tr>
						    </thead>
						    	<tbody>
						    	<?php
						    		$get_newslatter = $this->am->newsLatter("newslatter");
						    		$i=1;
						    		foreach ($get_newslatter as $key => $val) :
						    	?>
							    <tr>
							    	<td></td>
							    	<td><?php echo $i++;?></td>
							    	<td><?php echo $val['email']?></td>
							    	<td><a href="<?=base_url()?>admin/sendemail/<?php echo $val['e_id']?>" class="btn btn-primary" role="button">Send Email</a></td>
							    </tr>
						    <?php endforeach;?>
						    </tbody>
						</table>
