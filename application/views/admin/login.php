...
<title>Mquiz - Dashboard</title>

<link href="<?=base_url()?>css/css/bootstrap.min.css" rel="stylesheet">
<link href="<?=base_url()?>css/css/datepicker3.css" rel="stylesheet">
<link href="<?=base_url()?>css/css/styles.css" rel="stylesheet">
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading text-center admin">Admin Login</div>
					<!--<img src="<?=base_url()?>images/logo.png" alt="logo"> -->

				<div class="panel-body">
					<form role="form" role="form" method="post" action="<?=base_url()?>admin/login">
						<fieldset>
