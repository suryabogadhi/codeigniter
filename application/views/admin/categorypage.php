...
?>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Category Details
						<div class="pull-right">
							<a href="<?=base_url()?>admin/add_category" class="btn btn-primary" role="button">Add Category</a>
						</div>
					</div>
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="email" data-sortable="true">Image</th>
						        <th data-field="address" data-sortable="true">Alias Name</th>
							    ...
							    <tr>
							    	...
							    	<td><img src="<?=base_url()?>images/category/<?php echo $val['image_name']?>" width="80" height="50"></td>
							    	<td><?php echo $val['alias_name']?></td>
							    	<td><a href="<?=base_url()?>admin/edit_category/<?=$val['c_id']?>" class="btn btn-primary" role="button">Edit</a></td>
							    	<td><a href="javascript:;" onClick="confirm_delete(<?=$val['c_id']?>)" class="btn btn-danger" role="button">Delete</a></td>
							    </tr>
						    <?php endforeach;?>
						    </tbody>
						</table>
	...
	<script>
		...
		function confirm_delete($id){
			...
			if(res == true){
				window.location = "<?=base_url()?>admin/category_delete/"+$id;
			}
		}
	</script>	
</body>
